...
describe('extractRawLink', () => {
  ...
  it('should work for joyagoo (alt format)', () => {
    const href = 'https://joyagoo.com/product?id=916300125915&platform=TAOBAO';
    const rawLink = extractRawLink(new URL(href));
    expect(rawLink.href).toEqual(
      'https://item.taobao.com/item.htm?id=916300125915'
    );
  });
  ...
  it("should work for hubbuycn's new format", () => {
    const href =
      'https://www.hubbuycn.com/product/item?url=https://item.taobao.com/item.htm?id=675330231400';
    const rawLink = extractRawLink(new URL(href));
    expect(rawLink.href).toEqual(
      'https://item.taobao.com/item.htm?id=675330231400'
    );
  ...
  it('should work for hipobuy', () => {
    const href = 'https://hipobuy.com/product/1/675330231421';
    const rawLink = extractRawLink(new URL(href));
    expect(rawLink.href).toEqual(
